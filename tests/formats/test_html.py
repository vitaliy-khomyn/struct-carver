"""Unit tests for the HTML component."""
import unittest
from struct_carver.formats.text.html_parser import HTMLParser


class TestHTMLParser(unittest.TestCase):
    """Test suite for HTMLParser parsing and carving."""
    def setUp(self):
        self.parser = HTMLParser()

    def test_basic_and_void_tags(self):
        """Tests that basic and void tags."""
    ...
    def test_cross_chunk_comment_state(self):
        """Tests that cross chunk comment state."""
